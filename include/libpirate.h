...
typedef ssize_t (pirate_serialize_t)(const void* val, uint8_t* buf, size_t count);

typedef ssize_t (pirate_deserialize_t)(void* val, const uint8_t* buf, size_t count);

int pirate_register_serde(int gd, pirate_serialize_t *serialize,
    pirate_deserialize_t *deserialize, size_t bufsize);

ssize_t pirate_recv(int gd, void *val);

ssize_t pirate_send(int gd, const void *val);
